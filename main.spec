...
a = Analysis(['__main__.py'],
             pathex=[],
             binaries=[],
             datas=[('configs/levelconfigs/end_game_questions.json','configs/levelconfigs'),('configs/levelconfigs/after_block_questions.json','configs/levelconfigs'),('images/objects/coin.png','images/objects'),('images/objects/p1.png','images/objects'),('images/objects/p2.png','images/objects'),('images/objects/p3.png','images/objects'),('images/objects/p4.png','images/objects'),('images/background/1.png','images/background'),('images/background/2.png','images/background'),('images/background/3.png','images/background'),('images/background/start.png','images/background'),('images/background/instructions.png','images/background'),('images/background/pacman.png','images/background'),('fonts/ARIAL.TTF','fonts'),('configs/structure.json','configs'),('configs/levelconfigs/neutral.json','configs/levelconfigs'),('configs/levelconfigs/questions.json','configs/levelconfigs'),('configs/levelconfigs/questions2.json','configs/levelconfigs'),('configs/levelconfigs/goodSpeed.json','configs/levelconfigs'),('configs/levelconfigs/goodCoin.json','configs/levelconfigs'),('configs/levelconfigs/goodAll.json','configs/levelconfigs'),('configs/levelconfigs/badSpeed.json','configs/levelconfigs'),('configs/levelconfigs/badAll.json','configs/levelconfigs'),('configs/levelconfigs/badCoin.json','configs/levelconfigs'),('configs/levelconfigs/test.json','configs/levelconfigs')],
             hiddenimports=[],
             hookspath=[],
             hooksconfig={},
             runtime_hooks=[],
